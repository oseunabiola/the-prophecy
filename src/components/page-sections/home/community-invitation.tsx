        ...
        <div id="join-community" className="mx-auto bg-primary py-32 xl:py-36">
            <PageContainer>
                <div className="grid items-start justify-between gap-y-8 xl:grid-cols-12">
                    <div className="mx-auto grid w-9/12 gap-y-6 text-center xl:col-span-5 xl:w-11/12 xl:text-left">
                        <h2 className="text-[40px] xl:text-5xl xl:leading-[70px]">Invitation to the Prophetic Company</h2>
                        <p className="text-xl xl:w-[27ch]">Join now and grow in the prophetic with a supportive community!</p>
                        <div className="mx-auto grid md:w-6/12 xl:mx-0 xl:w-max">
                            <LinkButton to="/" variant="primary" className="px-8 py-3.5">
                                Join Now
                            </LinkButton>
                        </div>
                    </div>
                    <ul className="list-image mx-auto grid items-center gap-y-10 rounded-[8px] bg-body-bg px-6 py-14 text-justify text-xl xl:col-span-7 xl:w-10/12 xl:gap-y-12 xl:px-11 xl:py-20">
