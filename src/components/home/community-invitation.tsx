        ...
        <div className="mx-auto bg-primary py-36">
            <PageContainer>
                <div className="grid items-start justify-between gap-y-8 lg:grid-cols-12">
                    ...
                    <ul className="list-image col-span-12 mx-auto grid items-center gap-y-12 rounded-[8px] bg-body-bg px-8 py-20 text-justify text-xl lg:col-span-7 lg:w-10/12 lg:px-11">
