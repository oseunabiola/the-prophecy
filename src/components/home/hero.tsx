...
const Hero = () => {
    return (
        <PageContainer>
            <div className="grid gap-y-7 py-24 xl:grid-cols-12 xl:py-40">
                <div className="headline-section | order-1 grid gap-y-8 text-center xl:order-0 xl:col-span-7 xl:text-left">
                    ...
                    <div className="mx-auto grid w-10/12 gap-y-4 xl:w-max xl:grid-flow-col xl:justify-items-start xl:gap-x-6">
